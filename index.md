      ...
      <div class="hpa-stage-header">
        ...
        <div class="hpa-results-grid" aria-label="Diffusion model results">
          <article class="hpa-result-card">
            <h3>Breakthrough <span class="hpa-result-hint" tabindex="0" title="Shown for reference. Breakthrough is excluded from the diagnostic confidence score and global-fit seeding because it is less reliable than the other evaluation methods for this transient.">?</span></h3>
        ...
        <div class="hpa-preview-wrap" aria-live="polite">
          <table class="hpa-preview-table" aria-label="Parsed data preview">
            ...
            <tbody id="hpa-preview-body">
              <tr>
                <td colspan="5" class="hpa-empty">No data loaded.</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <div class="hpa-help-body">
      ...
      <div>
        ...
        <ul class="hpa-help-list">
          ...
          <li>If output smoothing is enabled, the preview table and CSV export show both the raw and smoothed <code>D<sub>app</sub></code> values. When positive <code>t<sub>0</sub></code> is used, both also show whether a row is measured data or reconstructed prepended baseline.</li>
        </ul>
      </div>
